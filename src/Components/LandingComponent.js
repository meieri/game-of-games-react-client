          ...
          <div className="row">
            <div className="media">
              ...
              <div className="media-body">
                <h5 className="media-body-heading">
                  Welcome to the Game of Games!
                </h5>
                <br />
                <p>
                  You've found yourself at the home of the Game of Games. We've
                ...
                <p>
                  ...
                  needs to do a tiny bit of preliminary work for the benefit of
                  the group. Once they've created the game board, they'll send
                  around a link to the other players who will work as a team to
                  create a game that'll "get the whole squad laughing".
                </p>
              </div>
            </div>
          </div>
